...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Album.num_sold'
        db.add_column(u'lyrics_album', 'num_sold',
        ...
        # Deleting field 'Song.song_title'
        db.delete_column(u'lyrics_song', 'song_title')
    ...
    def backwards(self, orm):
        # Deleting field 'Album.num_sold'
        db.delete_column(u'lyrics_album', 'num_sold')
        ...
        # Adding field 'Song.song_title'
        db.add_column(u'lyrics_song', 'song_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)
